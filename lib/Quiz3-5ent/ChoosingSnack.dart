...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  String getResultMessage() {
    ...
    if (percentage >= 0.8) {
      return '😋 You have excellent taste in snacks! 🏆';
    } else if (percentage >= 0.6) {
      return '👍 You made some good choices! Keep it up! 😊';
    } else if (percentage >= 0.4) {
      return '🤔 Not bad! Let\'s explore more snack options! 😉';
    } else {
      return '🍎 Time to learn more about yummy snacks! 😄';
    }
  }
