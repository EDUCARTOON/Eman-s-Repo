...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  final List<Map<String, dynamic>> questions = [
    // True or False:
    {
      'question': 'كليوباترا كانت فرعونًا لمصر.',
      'options': ['صح', 'خطأ'],
      'correctAnswer': 'صح',
    },
    {
      'question': 'بنى المصريون الأهرامات.',
      'options': ['صح', 'خطأ'],
      'correctAnswer': 'صح',
    },
    {
      'question': 'كانت آلة الزمن مملة.',
      'options': ['صح', 'خطأ'],
      'correctAnswer': 'خطأ',
    },
    {
      'question': 'سافر الأطفال إلى مصر في المستقبل.',
      'options': ['صح', 'خطأ'],
      'correctAnswer': 'خطأ',
    },
    {
      'question': 'حمل رجال كليوباترا على عرش.',
      'options': ['صح', 'خطأ'],
      'correctAnswer': 'صح',
    },
    // Multiple Choice:
    {
      'question': 'من حُمل على عرش؟',
      'options': ['ملك', 'ملكة', 'كليوباترا', 'إيميلي'],
      'correctAnswer': 'كليوباترا',
    },
    {
      'question': 'ماذا بنى المصريون؟',
      'options': ['منازل', 'سيارات', 'أهرامات', 'مركبات فضائية'],
      'correctAnswer': 'أهرامات',
    },
    {
      'question': 'إلى أين سافر الأطفال في آلة الزمن؟',
      'options': ['المستقبل', 'الماضي', 'مصر', 'كلاهما الماضي ومصر'],
      'correctAnswer': 'كلاهما الماضي ومصر',
    },
  ];
  ...
  String getResultMessage() {
    ...
    if (percentage >= 0.8) {
      return '👑 أنت عالم آثار عظيم! 🇪🇬';
    } else if (percentage >= 0.6) {
      return '🏺 ممتاز! لديك معرفة رائعة بمصر القديمة! 😊';
    } else if (percentage >= 0.4) {
      return '🧱 جيد! استمر في استكشاف أسرار الفراعنة! 👍';
    } else {
      return '🗺️ هيا نتعلم المزيد عن مصر القديمة وحضارتها العظيمة! 😄';
    }
  }
