...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  void checkAnswer(String selectedOption) {
    ...
    setState(() {
      ...
      if (selectedAnswer == questions[currentQuestionIndex]['correctAnswer']) {
        feedbackMessage = '😊 You are a great friend! 👍';
        correctAnswersCount++;
      } else {
        feedbackMessage = '🤝 Let\'s be kind to our friends! Try again! 🤔';
      }
  ...
  String getResultMessage() {
    ...
    if (percentage >= 0.8) {
      return '🥳 You are a wonderful friend! Playing with you is fun! 🎉';
    } else if (percentage >= 0.6) {
      return '🎈 You know how to be a good friend! Keep playing together! 😊';
    } else if (percentage >= 0.4) {
      return '🪁 Good try! Let\'s learn more about playing nicely with friends! 🤔';
    } else {
      return '🧸 Time to remember how to be a kind and fun friend! 😄';
    }
  }
                        ...
                        child: BounceInDown(
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              color: feedbackMessage == '😊 You are a great friend! 👍'
                                  ? Colors.green
                                  : Colors.red,
                            ),
                          ),
