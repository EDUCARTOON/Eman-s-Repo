...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  final List<Map<String, dynamic>> questions = [
    {
      'question': '🚦 A red light means "Go."',
      'options': ['True', 'False'],
      'correctAnswer': 'False',
    },
    {
      'question': '🛑 A stop sign means you must stop.',
      'options': ['True', 'False'],
      'correctAnswer': 'True',
    },
    {
      'question': '🚸 A school crossing sign means there are children nearby.',
      'options': ['True', 'False'],
      'correctAnswer': 'True',
    },
    {
      'question': '🚫 A no entry sign means you can go.',
      'options': ['True', 'False'],
      'correctAnswer': 'False',
    },
    {
      'question': '🚥 A green light means "Go."',
      'options': ['True', 'False'],
      'correctAnswer': 'True',
    },
    {
    ...
    {
      'question': 'What color is the "Go" light?',
      'options': ['Red', 'Yellow', 'Green'],
      'correctAnswer': 'Green',
    },
    {
      'question': 'What shape is a stop sign?',
      'options': ['Round', 'Triangle', 'Octagon'],
      'correctAnswer': 'Octagon',
    },
    {
      'question': 'Which sign shows it\'s safe to cross the road?',
      'options': ['🛑', '🚸', '🚫'],
      'correctAnswer': '🚸',
    },
    {
      'question': 'What should you do when you see a yellow light?',
      'options': ['Speed up', 'Get ready to stop', 'Jump'],
      'correctAnswer': 'Get ready to stop',
    },
  ];
  ...
  String getResultMessage() {
    ...
    if (percentage >= 0.8) {
      ...
      return '👍 Very good! Try again to be better! 👍';
    } else {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('🔁 Restart Quiz', style: TextStyle(fontSize: 18, color: Colors.white)),
